...
const columns = [
	...
	{ field: "title", headerName: "Title", minWidth: 150, flex: 0.9 },
	{ field: "subtitle", headerName: "Subtitle", minWidth: 150, flex: 0.9 },
	{ field: "category", headerName: "Category", minWidth: 200, flex: 1 },
	{ field: "synopsis", headerName: "Synopsis", minWidth: 200, flex: 1 },
	{
		field: "off_shelf_date",
		headerName: "Off Shelf Date",
		minWidth: 150,
		flex: 1,
	},
	{
...
export default function NewListView() {
	...
	useEffect(() => {
		async function getData() {
			const response = await fetch(`http://localhost:5000/data/new`);
